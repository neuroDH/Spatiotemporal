function [v_B_Bag, v_S_Bag,v_T_Bag, v_B_A_Bag,v_S_A_Bag,v_T_A_Bag,v_BarPlot,v_Erro,stru_Joint] = ...
    f_Plot_Asociated(stru_MergData,stru_MergFeat,str_Bol,str_Feat)
...
for i = 1:25
    ...
    v_Feat_HFA = v_Feat_C(v_Idx_PID);
    v_Feat_NO_HFA = v_Feat_C(v_Idx_PID_No);
    ...
    if strcmp(str_Bol,'HFA')

        v_Axis = v_Ax_HFA;
        v_Feat = v_Feat_HFA;

    elseif strcmp(str_Bol,'NOHFA')

        v_Axis = v_Ax_NO_HFA;
        v_Feat = v_Feat_NO_HFA; 
